...
import {Grid, Typography, TextField, CircularProgress, withStyles} from '@material-ui/core'
import {withRouter} from 'react-router'

import TodoItem from '../TodoItem'
import Filter from '../Filter'
import {SHOW_ALL, SHOW_COMPLETED} from '../../constants/actionType'
import {fetchTodolistIfNeeded, fetchTodolists, invalidateTodolists} from "../../actions/apiactions";
      ...
      <div className='TodoList'>
        {
          this.props.isFetching ?
            <CircularProgress/> :
            <Grid container item xs={12} spacing={24} justify="center" alignItems="center">
